...
// Центр и зум по Украине (без Крыма тайлы OSM всё равно показывают границы)
...
export default function AidMap() {
  ...
  return (
    <section className="section">
          ...
          <div className="flex flex-col gap-10 lg:flex-row">
            ...
            <div className="lg:w-2/3">
              <div className="relative overflow-hidden rounded-3xl border border-white/70 bg-white/80 shadow-sm">
                {/* Тёплая подложка под тайлами — визуально «сшивает» с общим градиентом сайта */}
            ...
            {/* Правый список — как в текущей версии */}
      ...
      {/* Диалог с подробностями можно вернуть на следующем шаге, если понадобится. */}
    </section>
  );
}
